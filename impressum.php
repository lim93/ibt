...
<body>
    ...
    <div id="pageHeader" class="header">
        ...
        <div class="navigation">
            <ul class="nav nav-tabs" style="background-color:white;">
                ...
                <li role="presentation" class="active"><a href="impressum.php">Impressum</a>
                </li>
            </ul>
        </div>
    ...
    <div class="content" id="content">
        ...
        <div class="intro">
            <div class='impressum'>
				<h1>Impressum</h1><p>Angaben gemäß § 5 TMG</p><p>Ristorante l'Imaginario <br> Bruchstr. 6<br> 45883 Gelsenkirchen <br> </p>
				<p> <strong>Vertreten durch: </strong><br> Ristorante l'Imaginario<br></p>
				<p><strong>Kontakt:</strong> <br>
				Telefon: (0211) -963411<br>
				E-Mail: <a href='mailto:info@Imaginario.de'>info@Imaginario.de</a></br></p>
				<p><strong>Aufsichtsbehörde:</strong><br>Gesundheitsamt<br></p>
				...
				<strong>Datenschutz</strong><br><br>
					...
					wird hiermit ausdrücklich widersprochen. Die Betreiber der Seiten behalten sich ausdrücklich rechtliche Schritte im Falle der unverlangten Zusendung von Werbeinformationen, etwa durch 
					Spam-Mails, vor.<br>
				</p><br> 
			</div>
		</div>
